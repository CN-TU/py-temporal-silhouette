...
DEFAULT_RUNS = '''
data/base/arff results/ base normal
data/base/arff results/ base-r remove
data/moving/arff results/ mov normal
data/moving/arff results/ mov-r remove
data/nonstat/arff results/ nonst normal
data/nonstat/arff results/ nonst-r remove
data/nonstat/arff results/ nonst-p phase
data/sequential/arff results/ seq normal
data/sequential/arff results/ seq-r remove
data/sequential/arff results/ seq-p phase
'''
...
for idf, filename in enumerate(glob.glob(os.path.join(inpath, '*.arff'))):
    ...
    den = DenStream(eps=0.3, lambd=0.1, beta=0.5, mu=11)
